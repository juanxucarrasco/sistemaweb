...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="doctorPC" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Doctor PC</b><br>Calle Prol. Sucre - Ferreñafe, Perú<br>Telefono:(+51)90000000<br>Email:jonathancarrasco@gmail.com
                </p>
            </div>
            <div id="fact">
